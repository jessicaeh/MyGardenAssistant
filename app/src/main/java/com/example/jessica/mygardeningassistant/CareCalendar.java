...
public class CareCalendar extends LinearLayout {

    private static final String TAG = CareCalendar.class.getSimpleName();
...
//    }
    ...
    public CareCalendar(Context context) {
        super(context);
    }
    public CareCalendar(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CareCalendar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }
    private void initializeUILayout(){
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.activity_care_calendar, this);
